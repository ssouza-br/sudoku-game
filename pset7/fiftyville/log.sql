...
SELECT id, name, phone_calls.receiver, phone_calls.id FROM people JOIN (SELECT caller FROM phone_calls WHERE day=28 AND month=07 AND year=2021 AND duration<=60) ON phone_number=caller;
